                ...
                <div class="card-body">
                  <?php echo form_open_multipart('');?>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="alamat" aria-describedby="alamat" name="alamat" value="<?=set_value('alamat')?>"
                        placeholder="Masukkan Alamat">
                        <?=form_error('alamat', '<small class="text-danger pl-3">', '</small>')?>
                    </div>
                    <div class="form-group">
                      <label for="nohp">No Hp</label>
                      <input type="number" class="form-control" id="nohp" aria-describedby="nohp" name="nohp" value="<?=set_value('nohp')?>"
